		...
		*/
		while(true){
			...
			if(choice.equals("file")){
				...
				System.out.println("How many words of the text would you like to output?");
				int a = sc.nextInt();
				sc.nextLine();
				if(a >= arr.length){
				...
				System.out.println("What word/phrase would you like to check for?");
				String b = sc.nextLine();
				int c = checksArray(arr, b);
				System.out.println("There are " + c + " many " + b + " in " + textFile);
			}
			else if(choice.equals("common")){
				String q = mostCommon(arr);
				System.out.println("The most common word in the text is: " + q);
			}
			// Your code goes here.
			System.out.println("----------");
		}
